...
言語についての注意です。`references/` 配下のリファレンスは、Apple の用語や API 名と一致させるため英語で書かれています。この README と NOTICE には日本語版（`README.ja.md`、`NOTICE.ja.md`）もあります。
